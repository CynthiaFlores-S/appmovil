/*************  FLORES SANCHEZ CYNTHA  *************************** */ 
/********************    TI02SM-18    ********************** */ 
/******  APP DE REGISTRO, APIS PHP Y MSQL  ********************** */ 
/*************************************************** */ 
       ...
       <Container>
        <Content padder contentContainerStyle = {misEstilos.content}>
          <Card>
            ...
            <CardItem bordered style={misEstilos.color}>
              <Body style = {misEstilos.color}>
            ...
            <Button  success style = {misEstilos.centrar} onPress = {this.userLog}><Text> Iniciar </Text></Button>
            </CardItem>


            <CardItem footer bordered style = { misEstilos.pie}>
            <Button  onPress={() => navigation.navigate('Registro')} primary style = { misEstilos.boton}><Text> Registrarse </Text></Button>
            </CardItem>
